...
<!-- Note: slice filename templates moved to xmlspec-wcag.xsl, so they can be used to create cross reference links. Also mode name changed to "slice-techniques-filename" -->
  ...
  <xsl:choose>
    ...
    <xsl:variable name="next" select="(following::technique | following::div2)[1]"/>
      	...
      	<xsl:result-document method="xml" href="file:///{$output.dir}/{$filename}" encoding="UTF-8" doctype-system="about:legacy-compat" indent="no">
        <html>
...
<div id="masthead"><p class="logo"><a href="http://www.w3.org/"><img width="72" height="48" alt="W3C" src="https://www.w3.org/StyleSheets/TR/2016/logos/W3C" /></a></p><p class="collectiontitle"><a href="./">WCAG 2.0 達成方法集</a></p></div>
